...
public class TSTOPDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        TSTOPGlobalFeatureConfigurator.Configure();
        TSTOPModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<TSTOPDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<TSTOPResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/TSTOP");

            options.DefaultResourceType = typeof(TSTOPResource);
        ...
        {
            options.MapCodeNamespace("TSTOP", typeof(TSTOPResource));
        });
    }
}
